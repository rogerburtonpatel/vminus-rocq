...
Proof.
  ...
  unfold t_update. 
  destruct (String.eqb x x0) eqn:eq; reflexivity.
Qed.  
(** [] *)
...
Proof.
  ...
  - rewrite e. unfold t_update. rewrite String.eqb_refl. reflexivity. 
  - unfold t_update. apply String.eqb_neq in n. rewrite n. reflexivity.
Qed.  
(** [] *)
...
Proof.
  ...
  - rewrite e. rewrite String.eqb_refl. rewrite H. reflexivity. 
  - apply String.eqb_neq in n. 
    rewrite (String.eqb_sym x1 x).
